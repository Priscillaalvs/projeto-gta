/*
Objetivo 1 - quando o usuário clicar no botão de seleção de plataformas deve abrir
...
// Objetivo 1 - quando o usuário clicar no botão de seleção de plataformas deve abrir na caixa com os botões de seleção de plataforma
